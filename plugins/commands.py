...
async def start(client, message):
    ...
    if len(message.command) != 2:
        # Clean start menu without referral/premium features
        buttons = [[
            InlineKeyboardButton('⤬ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ⤬', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
        ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        # Clean menu without referral/premium
        buttons = [[
            InlineKeyboardButton('⤬ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ⤬', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
        ],[
            InlineKeyboardButton('⚡ ɪɴʟɪɴᴇ sᴇᴀʀᴄʜ ⚡', switch_inline_query_current_chat='')
...
# Removed premium and referral commands (add_premium, remove_premium, plan, myplan)
